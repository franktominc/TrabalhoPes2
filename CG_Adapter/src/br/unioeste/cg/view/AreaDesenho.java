            ...
            if (p1 != null && p2 != null) {
                switch (shape) {
                    case 0:
                        ...
                        break;
                    case 1:
                        circles.add(new Circle(p1, (int) Point.distance(p1.x, p1.y, p2.x, p2.y), color));
                        break;
                    case 2:
                        ellipses.add(new Ellipse(p1, (int) Point.distance(p1.x, p1.y, p2.x, p1.y), (int) Point.distance(p1.x, p1.y, p1.x, p2.y), color));
                        break;
                }
            }
            p1 = null;
